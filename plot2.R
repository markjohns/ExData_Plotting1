...
##the second plot is a plot of Global Active Power (kilowatts) by day of the week
##create a new column with data and time and add it to data
##use mutate in the dplyr package
...
plot(data_with_date_time$Date_time, data_with_date_time$Global_active_power, ylab = "Global Active Power (kilowatts)", xlab = "", type = "l", pch = 3, lwd =1)
